...
is reported as unconfirmed. Qualification is limited to the exact macOS and
toolchain identities in [compatibility](docs/compatibility.md); Linux is rejected.
...
[acceptance ledger](docs/acceptance-status.json) for release-gate evidence. Nothing has been published or released.
